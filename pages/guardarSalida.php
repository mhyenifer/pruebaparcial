...
$sql = "INSERT INTO salida(codigo,nombre,nit,fecha,cod_tipo_movimiento,total) VALUES ($codigo,'$nombre','$nit','$fecha',2,0)";
...
$sql1 = "INSERT INTO salida_detalle(codigo,cantidad,codigo_producto,precio,total,codigo_salida) VALUES ($codigo1,$cantidad1,$producto1,$precio1,$total1,$codigo)";
...
$sql2 = "INSERT INTO salida_detalle(codigo,cantidad,codigo_producto,precio,total,codigo_salida) VALUES ($codigo2,$cantidad2,$producto2,$precio2,$total2,$codigo)";
...
$sql3 = "INSERT INTO salida_detalle(codigo,cantidad,codigo_producto,precio,total,codigo_salida) VALUES ($codigo3,$cantidad3,$producto3,$precio3,$total3,$codigo)";
...
for($i=1;$i<=3;$i++){
   ...
   if(!empty($productoInve)){
        ...
        $sqlp1inv= "INSERT INTO inventario(existencia_saldo,codigo_producto ,codigo_salida ,fecha) VALUES ($existenciaSaldoP1,$productoInve,$codigo,$fecha)";
